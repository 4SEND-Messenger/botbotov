...
Правила:
- "скинь дз", "дз", "кинь дз", "покажи дз" -> get_hw_week()
...
async def process_message(text, chat_id, user_id):
    system = AI_SYSTEM_PROMPT if AI_SYSTEM_PROMPT else SYSTEM_PROMPT
