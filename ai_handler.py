...
- get_hw_week(week: int) - показать дз на всю неделю
- get_hw_tomorrow() - показать дз на завтра (следующий учебный день)
- get_hw_today() - показать дз на сегодня
- get_schedule() - показать расписание
- get_next() - показать ближайший учебный день
